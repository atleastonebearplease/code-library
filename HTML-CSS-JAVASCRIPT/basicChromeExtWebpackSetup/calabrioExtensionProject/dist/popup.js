...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `/* Styles for the extension pop up window */
...
body {
    width: 20rem;
    height: 20rem;
}`, "",{"version":3,"sources":["webpack://./src/styles/popup.css"],"names":[],"mappings":"AAAA,2CAA2C;;AAE3C;IACI,sBAAsB;AAC1B;;AAEA;IACI,YAAY;IACZ,aAAa;AACjB","sourcesContent":["/* Styles for the extension pop up window */\n\n* {\n    box-sizing: border-box;\n}\n\nbody {\n    width: 20rem;\n    height: 20rem;\n}"],"sourceRoot":""}]);
// Exports
...
function getCurrentDaySchedule(scheduleColumns) {
    ...
    today = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(today, "yyyy-MM-dd");
